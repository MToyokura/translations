...
- より国際的な文脈を反映するよう、例、参考文献、統計を変更。
- 原版に含まれていなかったいくつかの概念、理論、主要研究の概要を追加。
- 各章の冒頭に学習目標の一覧を追加。
- 学生がすぐに参照できるよう、教科書の巻末に主要用語の用語集を追加。

さらに、以下の変更も行われましたが、これらには原著の [CC BY-NC-SA 3.0ライセンス](https://creativecommons.org/licenses/by-nc-sa/3.0/) が引き続き適用されます。
...
[B.C. Open Collection](https://collection.bccampus.ca/)
...
**電子書籍 ISBN:** 978-1-77420-193-0

**印刷版 ISBN:** 978-1-77420-192-3