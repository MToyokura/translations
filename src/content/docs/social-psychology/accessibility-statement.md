...
アクセシビリティ・チェックリストの表は、[Rebus Community](https://press.rebus.community/the-rebus-guide-to-publishing-open-textbooks/back-matter/accessibility-assessment/) が作成し、[CC BY 4.0ライセンス](https://creativecommons.org/licenses/by/4.0/) のもとで公開したものをもとに改変しています。
