...
- **使用する** — 自由ソフトウェアは、あらゆる目的に使用でき、ライセンスの有効期限や地理的制限などの制約を受けません。
- **調査する** — 自由ソフトウェアとそのソースコードは、秘密保持契約（NDA）やそれに類する制約なしに、誰でも調査・研究できます。
- **共有する** — 自由ソフトウェアは、ほぼ費用をかけずに共有・複製できます。
- **改良する** — 自由ソフトウェアは誰でも変更でき、その改良内容を公開して共有することができます。
...
- **自由ソフトウェア** — 1986年に生まれた、最初の呼称
- **オープンソース** — 1998年に、自由ソフトウェアを普及させるためのマーケティングキャンペーンとして設けられた呼称
- **Libre Software** — 英語の「free」が持つ曖昧さを避けるため、フランス語やスペイン語から「libre」という語を借用して生まれた呼称
- **FOSS / FLOSS** — Free (Libre) and Open Source Software の略称
