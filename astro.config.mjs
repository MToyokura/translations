      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/MToyokura/translations",
        },
      ],
      sidebar: [
        {
          ...
          items: [
            {
              ...
              items: [
                {
                  label: "オープンアクセスとは？",
                  slug: "open-access-network/information/open-access-primers/what-does-open-access-mean",
                },
                {
                  label: "オープンアクセスと再利用",
                ...
                {
                  label: "オープンアクセスと研究データ",
                  slug: "open-access-network/information/open-access-primers/open-access-to-data",
                },
              ],
            },
          ],
